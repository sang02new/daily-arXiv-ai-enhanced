...
### [1] [Quantifying the Biophysical Properties of Red Blood Cells in Gaucher Disease](https://arxiv.org/abs/2608.24021)
...
### [2] [Multi-Stage Prompt-Guided Feature Modulation for Generalizable Brain Tumor Segmentation](https://arxiv.org/abs/2608.23745)
...
### [3] [Spatiotemporal Distillation via Recurrent Bottlenecks for Aortic Tracking](https://arxiv.org/abs/2608.23879)
...
### [4] [Native-Space 3D CarveMix for Multi-Site T1w Stroke Segmentation](https://arxiv.org/abs/2608.23882)
...
### [5] [Model Effect or Label Effect? Refined Annotations and a Human-Referenced Benchmark for Pulmonary Embolism Segmentation](https://arxiv.org/abs/2608.24486)
...
### [6] [Score-Based Ideal Observer Approximation via Denoising Score Matching for Signal-Known-Exactly Detection Tasks](https://arxiv.org/abs/2608.24768)
*Weimin Zhou*
...
### [7] [The Stokes resistance of an arbitrary particle: a classification of hydrodynamic symmetries](https://arxiv.org/abs/2608.23907)
*Clément Moreau*
...
### [8] [Momentum-scalar coupled turbulence with anomalous momentum and scalar diffusions. Part 1: Without external force and with long-range external force](https://arxiv.org/abs/2608.23946)
*Wei Zhao*
...
### [9] [Momentum-scalar coupled turbulence with anomalous momentum and scalar diffusions. Part 2: With short-range external force and implementation in electrokinetic turbulence](https://arxiv.org/abs/2608.23947)
*Wei Zhao*
...
### [10] [Backflow-Induced Inertial Arrest of Velocity Fluctuations in Sedimenting Suspensions](https://arxiv.org/abs/2608.23997)
*Hsien-Hung Wei*
...
### [11] [Assessment of turbulent fire dynamics and combustion instabilities using a flamelet model](https://arxiv.org/abs/2608.24323)
...
### [12] [Feedback control of vortex shedding using data-driven modelling](https://arxiv.org/abs/2608.24435)
...
### [13] [Effects of pressure on the chemical sooting structure of equi-diffusive counterflow diffusion flames](https://arxiv.org/abs/2608.24816)
...
### [14] [Ice melting in an oscillatory flow](https://arxiv.org/abs/2608.24875)
...
### [15] [Validation of HRV Studio: A Transparent and Quality-Control-Aware Platform for Heart Rate Variability Analysis](https://arxiv.org/abs/2608.24241)
