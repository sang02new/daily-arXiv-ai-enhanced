...
### [1] [Simultaneous 3D co-registered perfusion and oxygenation with ULM, photoacoustic imaging, and a planar matrix array](https://arxiv.org/abs/2608.19823)
...
### [2] [The near-wall cycle for skin-friction generation revealed through explainable deep learning](https://arxiv.org/abs/2608.19213)
...
### [3] [Generalised Perturbed Convective Wave Theory](https://arxiv.org/abs/2608.19236)
...
### [4] [Weakly nonlinear internal waves by tidal flow over a ridge in a shear current](https://arxiv.org/abs/2608.19237)
*Xun Huang*
...
### [5] [Modeling the compressible flow field of an impulsively started circular cylinder with refined potential flow theory](https://arxiv.org/abs/2608.19246)
...
### [6] [A Sharp and Conservative VOF Method for Multicomponent Liquid--Gas Mass Transfer: Bubble Dissolution and Droplet Evaporation](https://arxiv.org/abs/2608.19254)
...
### [7] [Effect of Microscale Turbulent Structures Dynamics on Forced Convection in Turbulent Porous Media Flow](https://arxiv.org/abs/2608.19342)
...
### [8] [Stability and nonlinear dynamics of three-layer viscous films inside a vertical cylindrical tube](https://arxiv.org/abs/2608.19417)
...
### [9] [SoilWaterNow: Soil water nowcasting for mapping plant available water (PAW) across paddocks for improved on-farm decision-making](https://arxiv.org/abs/2608.19930)
...
### [10] [Growth phases of an active tissue: determinate, indeterminate, and proportionate](https://arxiv.org/abs/2608.20091)
...
### [11] [Miniature giants: investigating limb long bone structure in dwarf proboscideans](https://arxiv.org/abs/2608.19205)
...
### [12] [Deep Learning for Automated Quantification of Tumor-Associated Macrophages from H&E-Stained Slides in Diffuse Large B-Cell Lymphoma](https://arxiv.org/abs/2608.19283)
...
### [13] [MOSAIC: A Self-supervised Dynamic Multi-encoding Reconstruction Framework for 3D Late Gadolinium Enhancement MRI](https://arxiv.org/abs/2608.19506)
...
### [14] [Flow Matching-Based PET Image Reconstruction](https://arxiv.org/abs/2608.20112)
...
### [15] [Loss-Resilient Semantic Communication over Packet-Loss Networks at Extreme-Low Bandwidth](https://arxiv.org/abs/2608.19590)
...
### [16] [AsymFeX: A Symmetry-Driven Framework for Ischemic Stroke Segmentation Across Imaging Modalities and Stroke Stages](https://arxiv.org/abs/2608.19769)
...
### [17] [MOSAIC: Modality-agnostic Spectral Alignment for Federated Image-level Weakly Supervised Tumor Segmentation under Client-specific Missing Modalities](https://arxiv.org/abs/2608.19788)
...
### [18] [Energy-Mamba: A Physics-Constrained State-Space Model for Medical Image Classification](https://arxiv.org/abs/2608.19813)
...
### [19] [Simulation-to-Real First-Break Segmentation for Efficient Inversion in Musculoskeletal Ultrasound Tomography](https://arxiv.org/abs/2608.19828)
