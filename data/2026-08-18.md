...
### [1] [Focal-point scanning for dose delivery and optimization with focused laser-accelerated very-high-energy electron beams](https://arxiv.org/abs/2608.13919)
...
### [2] [Birth of the Coil: another Milestone towards a fully reproducible low-field MRI scanner for head-imaging](https://arxiv.org/abs/2608.14139)
...
### [3] [MRI-guided cardiac radiotherapy using a 1.5 T MR-linac: surveying emerging patterns of care](https://arxiv.org/abs/2608.14213)
...
### [4] [Classification of Intracellular Protein Patterns from Reactive Equilibria](https://arxiv.org/abs/2608.13821)
...
### [5] [Length scale of cellular activity determines signatures of epithelial remodeling](https://arxiv.org/abs/2608.14458)
...
### [6] [Low-dimensional Galerkin projection models for predicting turbulent secondary mean flow in a square duct](https://arxiv.org/abs/2608.13771)
...
### [7] [Cross-frequency amplification of perturbations in a laminar separation bubble using resolvent analysis](https://arxiv.org/abs/2608.13788)
...
### [8] [Elastic wakes mediate collective viscoelastic fluid-structure interactions in side-by-side cantilever arrays](https://arxiv.org/abs/2608.13908)
...
### [9] [Long-time behavior of optimal mixing in an advection-diffusion shell model](https://arxiv.org/abs/2608.14346)
...
### [10] [Data-driven modeling of hypersonic flows in chemical non-equilibrium with catalytic surfaces](https://arxiv.org/abs/2608.14445)
...
### [11] [Secret-Stego Dissimilarity as a Design Axis: Invertible Coverless Image Steganography with Diffusion Models](https://arxiv.org/abs/2608.13597)
...
### [12] [LoopVSR: A Loop Engineering Framework for Automated Repair of Visual Speech Recognition Inference Pipelines](https://arxiv.org/abs/2608.13610)
...
### [13] [TRUE-Colon: Exposing a Consistent Transfer Asymmetry in Real-Time Polyp Detection](https://arxiv.org/abs/2608.13711)
...
### [14] [VLM- and LLM-Driven Multi-Agent System for PET Image Denoising](https://arxiv.org/abs/2608.13791)
...
### [15] [From crown candidates to neighborhood screening: integrating optical GeoAI and spatial modeling for urban-canopy assessment in Davis, California](https://arxiv.org/abs/2608.13856)
...
### [16] [Practical Lossless Volumetric Medical Image Compression via Tri-plane Context Tree Learning](https://arxiv.org/abs/2608.13897)
...
### [17] [A Subjective Study on a New Sharpness Informed Class of Metrics](https://arxiv.org/abs/2608.13989)
...
### [18] [UMPIRE-Net: Unrolled Magnitude-Phase Regularization Network for Accelerated MRI](https://arxiv.org/abs/2608.14422)
...
### [19] [Personalized Digital Semantic Communication for Image Transmission with Vision-Language Models](https://arxiv.org/abs/2608.14260)
