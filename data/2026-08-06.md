...
### [1] [DefoEye: Python-Based Software for Facilitating Time-Series InSAR Analysis of Sentinel-1 Remote-Sensing Data](https://arxiv.org/abs/2608.04915)
...
### [2] [AI-based single-shot structured-light depth reconstruction for real-time laparoscopic surgical guidance](https://arxiv.org/abs/2608.05109)
...
### [3] [Impact of Wind Direction on Flow and Turbulent Statistics Over a Realistic Urban Area: A Large-Eddy Simulation Study](https://arxiv.org/abs/2608.04136)
...
### [4] [Floquet stability analysis of pulsatile particle-laden channel flow](https://arxiv.org/abs/2608.04161)
...
### [5] [An Artificial-Compressibility Physics-Informed Neural Network for the Unsteady Incompressible Navier--Stokes Equations](https://arxiv.org/abs/2608.04191)
*Aytekin Çibik*
...
### [6] [TIDE: A Physically Diverse 3D Turbulence Benchmark Dataset for Advancing Scientific Machine Learning](https://arxiv.org/abs/2608.04222)
...
### [7] [Beyond the Mean-flow: A Spectral-Dynamic Approach to Unraveling the Physics of Droplet Capture in Fog Harvesting Meshes](https://arxiv.org/abs/2608.04325)
...
### [8] [Expansion of a hole in a viscoelastic liquid sheet](https://arxiv.org/abs/2608.04345)
...
### [9] [Reliable and efficient steady CFD from surrogate predictions through Newton-Krylov correction](https://arxiv.org/abs/2608.04400)
...
### [10] [Interfacial dynamics and energy cascade in immiscible Rayleigh-Taylor turbulence](https://arxiv.org/abs/2608.04447)
...
### [11] [Higher-Order Extensions of Weakly Viscous Dysthe Theory and a Phase-Lag Model for Nonlinear Mean-Flow Damping](https://arxiv.org/abs/2608.04473)
*C. M. Schober,A. Islas*
...
### [12] [Erodible bed turbulence modulation driven by transition between longitudinal and transverse bedforms at varying Shields numbers](https://arxiv.org/abs/2608.04648)
...
### [13] [Free-surface curvature and its relation to subsurface turbulence](https://arxiv.org/abs/2608.04687)
...
### [14] [A hybrid proper orthogonal decomposition and diffusion framework for reduced-order forecasting of turbulent flow dynamics](https://arxiv.org/abs/2608.04728)
...
### [15] [Laminar gaps mirror turbulent puffs in pipe flow](https://arxiv.org/abs/2608.04823)
...
### [16] [Extreme flows: where physics meets mathematically rigorous bounds](https://arxiv.org/abs/2608.04859)
*Bartosz Protas*
