...
### [13] [Optimal Transport Metric Learning for Feature Alignment in Partially Supervised Segmentation](https://arxiv.org/abs/2609.19176)
...
### [14] [Sustainable MRI: Interpretable Deep Learning for estimating energy and power consumption, revealing key acquisition parameters and their interactions](https://arxiv.org/abs/2609.19178)
...
### [15] [Coupling Hyperspectral and 3D Data for the preventive Conservation of Palace-museums](https://arxiv.org/abs/2609.19179)
...
### [16] [Perceptual Refinement of an End-to-End Video Streaming Pipeline via Generative AI Layers](https://arxiv.org/abs/2609.19215)
...
### [17] [Physics-Informed Hemodynamic Modeling for Data-Free Prediction and Sparse-Data Assimilation](https://arxiv.org/abs/2609.19290)
...
### [18] [NIMARC-MRI: Abdominal HASTE Dataset and a Baseline U-Net Exposing the Synthetic-to-Real Gap in Low-Resource Motion Correction](https://arxiv.org/abs/2609.19323)
...
### [19] [Mammography Foundation Models for Opportunistic Prediction of Major Adverse Cardiovascular Events](https://arxiv.org/abs/2609.19385)
...
### [20] [Compression Hurts, Pooling Helps: Information Loss in Rayleigh-Scale Estimation from B-Mode Ultrasound](https://arxiv.org/abs/2609.19525)
...
### [21] [The segmentation ceiling: why explicit left-ventricular masks do not improve learned ejection-fraction regression](https://arxiv.org/abs/2609.19730)
...
### [22] [HyperAMS-Net: Adaptive Multi-Scale Spatial Hypergraph Network for Brain Disorder Classification](https://arxiv.org/abs/2609.19755)
...
### [23] [Video Based Assessment of Surgical Skills Using Frozen Pretrained Video Foundation Models](https://arxiv.org/abs/2609.19772)
...
### [24] [Effects of Sequence Timing on the Spatio-Temporal Properties of 3D BOLD fMRI: A Formal Framework and Analysis](https://arxiv.org/abs/2609.20105)
...
### [25] [Unifying Image Quality Assessment Datasets: MOSAIQ-500K and MOSAIQ-Bench](https://arxiv.org/abs/2609.20247)
...
### [26] [Synthetic Fingerprints for Children Under Four: Generation and Biometric Evaluation](https://arxiv.org/abs/2609.20621)
...
### [27] [T2 estimation from MOLLI acquisitions](https://arxiv.org/abs/2609.19987)
...
### [28] [The Motile-Units model: Interacting spins model of cell polarization and motility](https://arxiv.org/abs/2609.20587)
