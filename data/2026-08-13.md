...
### [1] [A 2D Hydrothermodynamic Analytical Model for Rapid Tumor Ablation using High-Intensity Focused Ultrasound](https://arxiv.org/abs/2608.12200)
*D. Tsiklauri*
...
### [3] [Decodable but Not Accessible: Auditing Distance-Based Reliability Estimation on Disentangled Skin-Lesion Representations](https://arxiv.org/abs/2608.11267)
*Duc-Vinh Tran*
...
### [4] [Hardware-Aware Deployment of Joint SAR Compression and Despeckling on FPGA](https://arxiv.org/abs/2608.11271)
...
### [5] [Geometry-Based Compression of Plenoptic Point Clouds](https://arxiv.org/abs/2608.11273)
...
### [6] [Uncertainty-Aware and Explainable Ensemble Deep Learning Framework for Multi-Class Skin Lesion Classification](https://arxiv.org/abs/2608.11280)
...
### [7] [Physics-Informed Implicit Neural Representations for Improved Myocardial Perfusion MRI Quantification](https://arxiv.org/abs/2608.11282)
...
### [8] [Uncertainty-Aware Compositional Localization and Placement Assessment of Catheters and Tubes in Chest X-Rays](https://arxiv.org/abs/2608.11288)
*Harshil Lodhiya*
...
### [9] [SinoDiff: Physics-Consistent Self-Supervised Diffusion for Unified Low-Dose to Standard-Dose PET Sinogram Recovery](https://arxiv.org/abs/2608.11514)
...
### [10] [Boundary-Continuous Cross-Camera RGB Mapping via Hue-Split Model Trees](https://arxiv.org/abs/2608.11548)
...
### [11] [Alignment of Similarity-Transformed Images Based on Fourier--Mellin Transform Using Auxiliary Function Method](https://arxiv.org/abs/2608.11565)
...
### [12] [A comparison of CNN architectures for Alzheimer's disease detection in single-view MRI scans](https://arxiv.org/abs/2608.11762)
...
### [13] [ResPCC: A Loss-Resilient Neural Point Cloud Codec over Lossy Networks](https://arxiv.org/abs/2608.11845)
...
### [14] [Domain-Aware Lightweight Spectral-Grouped Convolutions for Hyperspectral Fish Freshness Classification](https://arxiv.org/abs/2608.12227)
...
### [15] [Anisotropic Thermalization in Far-from-Equilibrium Flows](https://arxiv.org/abs/2608.11445)
...
### [16] [Influence of Flow on Discharge Behaviors and CO2 Conversion in Gliding Arc Discharges](https://arxiv.org/abs/2608.11463)
...
### [17] [Thermochemical non-equilibrium effects on turbulent boundary layers](https://arxiv.org/abs/2608.11717)
...
### [18] [A transport geometry of acoustic analogies:exact holonomy of source re-attribution and its observable consequences](https://arxiv.org/abs/2608.12031)
*Sparsh Sharma*
...
### [19] [Strain-coupled one-dimensional turbulence for rapid distortion](https://arxiv.org/abs/2608.12048)
*Sparsh Sharma*
...
### [20] [Effects of Soret Diffusion and Radiative Heat Loss on the Evolution of Buoyant Flame Kernels in Ultra-Lean Hydrogen-Air Mixture](https://arxiv.org/abs/2608.12223)
