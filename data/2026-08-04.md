...
### [1] [Anticipatory Digital Twins for Online Head-and-Neck Adaptive Proton Therapy via Foundation-Model Registration](https://arxiv.org/abs/2608.00831)
...
### [2] [Cardiovascular Digital Twins from Physics Based to Data Driven Approaches](https://arxiv.org/abs/2608.02135)
...
### [3] [Bayesian comparison of Langevin dynamics for cell motility from positional observation](https://arxiv.org/abs/2608.00846)
...
### [4] [Noise-induced stability of insect swarms](https://arxiv.org/abs/2608.00314)
...
### [5] [Is K+ current in Action Potential real?](https://arxiv.org/abs/2608.00654)
*János Végh*
...
### [8] [Funnel-like protein energy landscapes emerge from functional evolution under thermal fluctuations](https://arxiv.org/abs/2608.01143)
...
### [9] [Fast Trainable Multilinear Bases for Image Compression](https://arxiv.org/abs/2608.00053)
...
### [10] [FDIR: Harmonizing Fidelity and Human-Machine Preference in Lossy Compression Image Restoration](https://arxiv.org/abs/2608.00111)
...
### [11] [RPL-UIE: Reliable Prior Learning for Underwater Image Enhancement](https://arxiv.org/abs/2608.00137)
...
### [12] [Automatic LV Localization and Short-Axis Plane Estimation from Arbitrary CMR Slice](https://arxiv.org/abs/2608.00145)
...
### [13] [MedSAM2-Anatomy: Training-Free Inference-Time Optimization for Musculoskeletal Segmentation](https://arxiv.org/abs/2608.00195)
...
### [14] [Learning to See Locally and Align Clinically with Pathology Semantics for Radiology Report Generation](https://arxiv.org/abs/2608.00279)
*Xuan Cuong Ngo*
...
### [15] [Fused electrical impedance tomography using an electromagnetically tracked handheld probe for oral cancer margin assessment: reconstruction methods and phantom validation](https://arxiv.org/abs/2608.00312)
...
### [16] [Streamable Neural Video Compression: A Mixed Precision Approach for Cross-Platform Deployment](https://arxiv.org/abs/2608.00483)
...
### [17] [Spinal-Multiple-Myeloma-SEG: A Dual-Energy CT Dataset Extended with Trabecular Bone Segmentation of Lumbar Vertebrae](https://arxiv.org/abs/2608.01482)
...
### [18] [Hadamard-Domain Model Quantization for Learned Image Coding](https://arxiv.org/abs/2608.01653)
...
### [19] [Mapping melliferous tree species in Kenya via one-class classification with hyperspectral unsupervised domain adaptation](https://arxiv.org/abs/2608.02045)
...
### [20] [Protocol generalisation for brain tissue microstructure estimation via hypernetwork-controlled geometric deep learning](https://arxiv.org/abs/2608.02053)
...
### [21] [An Accessible Solution for Deformable Image Registration Compared with Learning-Based Approaches](https://arxiv.org/abs/2608.02248)
...
### [22] [Multiscale passive scalar turbulence in a compressed subspace via tensor trains](https://arxiv.org/abs/2608.00194)
...
### [23] [Elasto-hydrodynamics of droplet-pool-interactions](https://arxiv.org/abs/2608.00274)
...
### [24] [Buoyancy-driven melt rate of a vertical ice surface in seawater](https://arxiv.org/abs/2608.00731)
...
### [25] [Physics-informed neural networks for two-dimensional wall-reactive solute dispersion in canonical shear flows](https://arxiv.org/abs/2608.00856)
...
### [26] [4D Topology optimization of moving rigid bodies in fluid flows](https://arxiv.org/abs/2608.01071)
...
### [27] [Stable and Efficient One-Way Modelling of Convective Disturbances in Laminar Boundary Layers: OWNS-Summation](https://arxiv.org/abs/2608.01155)
...
### [28] [Cross-stream pressure support and the limits of scalar relaxation in rarefied Poiseuille flow](https://arxiv.org/abs/2608.01224)
...
### [29] [Supersonic jet impingement on concave surfaces](https://arxiv.org/abs/2608.01542)
...
### [30] [Leidenfrost droplets: The roles of ambient humidity and internal droplet circulation](https://arxiv.org/abs/2608.01828)
...
### [31] [Measurements of non-linear energy transfer in canonical and drag-reduced turbulent boundary layers](https://arxiv.org/abs/2608.02003)
...
### [32] [Coherent structure modulation and recovery in drag-reduced turbulent boundary layers](https://arxiv.org/abs/2608.02017)
...
### [33] [Aerodynamic Drag and Heat Transfer Corrections for Dehydrated Pollen Particles: CFD-Based Modeling of Airborne Allergen Transport in Smart Urban Environments](https://arxiv.org/abs/2608.02360)
