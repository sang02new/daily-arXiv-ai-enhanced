...
### [1] [Beyond Dose in Boron Neutron Capture Therapy: Cellular $^{10}$B-Capture Statistics and Microdosimetric Context in Effect Prediction](https://arxiv.org/abs/2609.03130)
...
### [2] [Improving Clinical Target Volume Segmentation Accuracy using Anatomical Priors and Active Learning for the AGITG TOPGEAR Clinical Trial](https://arxiv.org/abs/2609.03186)
...
### [3] [Fast Patient-Specific Breast CT Dosimetry: 22-Fold Acceleration of Monte Carlo MGD Estimation](https://arxiv.org/abs/2609.03263)
...
### [4] [HPC Modeling of Coupled Elastic-Acoustic Wave Propagation in Biological Media: Numerical Validation](https://arxiv.org/abs/2609.03644)
...
### [5] [Advances in Machine Learning for Directed Evolution: A Five-Year Retrospective](https://arxiv.org/abs/2609.03046)
*Bruce J. Wittmann*
...
### [6] [An Integrative Computational Approach to Predict Viral Epitopes by Targeting the MHC-TCR Complexation](https://arxiv.org/abs/2609.03182)
...
### [7] [Structural control over equilibrium silicon and oxygen isotopic fractionation: A first-principles density-functional theory study](https://arxiv.org/abs/2609.03486)
...
### [10] [Learning from Scarce Labels: Multi-View Echocardiography for Ejection Fraction Prediction](https://arxiv.org/abs/2609.02969)
...
### [11] [Beyond Blur: A Semantic Tri-view Pipeline for Teledermatology Gradability via Skin Micro-relief](https://arxiv.org/abs/2609.03095)
*Robert Engel*
...
### [12] [Plant Growth Estimation with a Camera-Based Vegetation Index Mapping System for Agricultural Ground Vehicles](https://arxiv.org/abs/2609.03872)
...
### [13] [Computationally Efficient Pathology Segmentation using Knowledge Distillation from Foundation Models](https://arxiv.org/abs/2609.03947)
...
### [14] [Finite-source filtering and Doppler modulation of infragravity waves generated by breakpoint forcing](https://arxiv.org/abs/2609.03300)
...
### [15] [Cascade coalescence dynamically sustains bubble retention near gas-evolving surfaces](https://arxiv.org/abs/2609.03387)
...
### [16] [Interface-resolved simulations of boiling heat transfer](https://arxiv.org/abs/2609.03396)
...
### [17] [A conservative coupling method of sharp-interface and multi-species model for compressible reacting gas-liquid flows with phase change](https://arxiv.org/abs/2609.03509)
...
### [18] [Mach-number-dependent dissipative anomaly in isothermal compressible turbulence](https://arxiv.org/abs/2609.03945)
...
### [19] [How do flapping avian wing exhibit superior aerodynamic performance?](https://arxiv.org/abs/2609.03957)
...
### [20] [Analytic study of the continuous spectrum of three-dimensional weak shock layers](https://arxiv.org/abs/2609.03969)
*Vassilis Theofilis*
...
### [21] [Dissipation scaling in wind turbine wakes exposed to free-stream turbulence](https://arxiv.org/abs/2609.03996)
...
### [22] [Internal geometries regulate the symmetry of defect configurations in cell populations confined to domains with a negative Euler characteristic](https://arxiv.org/abs/2609.03328)
...
### [23] [A regenerating free-energy register for protein-templated period-2 DNA synthesis by Drt3b](https://arxiv.org/abs/2609.03865)
*Wei-Wei Zhang*
