...
### [1] [Agentic Autoresearch for CT Reconstruction](https://arxiv.org/abs/2607.22824)
...
### [2] [Circulating Lymphocytes Preservation in Lung Cancer Stereotactic Body Radiation Therapy with Ultra-Fast Proton Delivery Using Modularized Pin Ridge Filters](https://arxiv.org/abs/2607.22842)
...
### [3] [Sleep-related forcing of cerebrospinal fluid streaming transport through the third ventricle](https://arxiv.org/abs/2607.24501)
...
### [4] [Evaluation of reference region modelling techniques in quantitative dynamic contrast-enhanced magnetic resonance imaging of breast cancer](https://arxiv.org/abs/2607.23327)
...
### [5] [Temperature dependence of Bloch equations](https://arxiv.org/abs/2607.23452)
*David H. Gultekin*
...
### [6] [Optically Encoded Suspension Microarrays: Materials, Design Strategies, and Future Directions for Multiplexed Bioanalysis](https://arxiv.org/abs/2607.24559)
...
### [7] [Plasma-activated water and phenolic compounds: A potent combined strategy against yeast resilience](https://arxiv.org/abs/2607.23701)
...
### [8] [Computational modelling reveals advantages of ventricular over atrial cardiomyocytes to power self-guided biorobots](https://arxiv.org/abs/2607.24565)
*Nathan Lilly,Guy S. Bewick,Claudiu Vasile Giuraniuc,Maria Elena Giannaccini*
...
### [9] [Characterisation of a multistable turbulent wake: application of an improved regime identification with analytical model training](https://arxiv.org/abs/2607.23206)
...
### [10] [Dynamics of fluid-fluid displacements in a model rough fracture beyond the quasistatic limit: A spectral approach](https://arxiv.org/abs/2607.23759)
...
### [11] [Adjoint Sensitivity Maps for Passive Flow Control Around Rotating Circular Cylinders Across a Wide Operating Envelope](https://arxiv.org/abs/2607.23831)
*Niklas Kühl*
...
### [12] [Influence of a vertical-wall leading edge on bouncing and escape bubble rising regimes](https://arxiv.org/abs/2607.24248)
...
### [13] [Bubble growth on arrays of micro-electrodes](https://arxiv.org/abs/2607.24286)
...
### [14] [The balance between compactness and forecast accuracy of data-driven latent-space reduced-order models in controlled wake flows](https://arxiv.org/abs/2607.24569)
...
### [15] [A Modified Moving Reference Frame Method for Propeller Resolution](https://arxiv.org/abs/2607.24630)
...
### [16] [pyALDIC: A Python Implementation of Augmented Lagrangian Digital Image Correlation with a GUI, Adaptive Meshing, and Mask-Aware Subset Splitting](https://arxiv.org/abs/2607.22755)
...
### [17] [Frequency-Aware Dual-Stream Learning for Balanced Realism and Fidelity in Electron Microscopy Imaging](https://arxiv.org/abs/2607.22765)
...
### [18] [Generative Video Compression with Adaptive Score Distillation](https://arxiv.org/abs/2607.22772)
...
### [19] [Metric Surface Reconstruction of Neurosurgical Scenes from Monocular Operating Microscope Images and Microscope Pose](https://arxiv.org/abs/2607.22773)
...
### [20] [JPEG AIC2026: A large-scale dataset for fine-grained assessment of image coding](https://arxiv.org/abs/2607.22783)
...
### [21] [Learning-based Hierarchical Tracheal Anatomy Understanding from Sparse Surgical Demonstration Annotations for Ultrasound Robots](https://arxiv.org/abs/2607.22789)
...
### [22] [Small, Bias-Free, Blind and Convolutional Denoiser: A compact ConvNeXt U-Net for blind Gaussian color-image denoising](https://arxiv.org/abs/2607.22793)
*Nikolas Markou*
...
### [23] [DY-LUT: Depth-Aware YCbCr Lookup Tables for Real-Time Underwater Image Enhancement](https://arxiv.org/abs/2607.22801)
...
### [24] [Learning Dense 2D-3D Correspondence for X-ray-to-CT Registration of Knee Bones](https://arxiv.org/abs/2607.22803)
...
### [25] [PriSAR: 3D Geometric-Prior-Guided Diffusion for Parameter-Controlled SAR Image Generation](https://arxiv.org/abs/2607.22963)
...
### [26] [Optimized Embedded Implementation of Hyperspectral-Multispectral Image Fusion on Raspberry Pi](https://arxiv.org/abs/2607.23136)
...
### [27] [A Reference-Free Framework for Evaluating Single-Frame ISP Pipelines](https://arxiv.org/abs/2607.23321)
...
### [28] [Stabilizing Deep Reconstruction Operators with Contractive Anchoring](https://arxiv.org/abs/2607.23341)
...
### [29] [Patient-Agnostic Synthetic Pretraining for Efficient Patient-Specific Intraoperative 2D/3D Registration](https://arxiv.org/abs/2607.23343)
...
### [30] [Trainable Nonexpansive Denoisers for Contractive Image Reconstruction](https://arxiv.org/abs/2607.23347)
...
### [31] [Codebook Capacity Governs Perceptual Quality Across Resolutions in Hierarchical Discrete Video Compression](https://arxiv.org/abs/2607.23366)
...
### [32] [Investigating the Visual Cues of CNNs for Vascular Segmentation: A Case Study in Microscopy and Fundus Imaging](https://arxiv.org/abs/2607.23371)
...
### [33] [Direction-adaptive Mamba: Spatial-Frequency Dual-Domain Collaborative Learning for PolSAR Image Classification](https://arxiv.org/abs/2607.23464)
...
### [34] [Segmentation Robustness and Predictive Utility in Glioblastoma Radiomics: Evidence for a Trade-off in Survival Modelling](https://arxiv.org/abs/2607.23626)
...
### [35] [A Controlled Visual-Backbone Benchmark for Multimodal Short-Term Solar Irradiance Forecasting](https://arxiv.org/abs/2607.23633)
...
### [36] [Rapid quantitative chemical composition mapping using model-based MRI reconstruction with field inhomogeneity correction](https://arxiv.org/abs/2607.24441)
...
### [37] [Efficient Ultrasound Image Segmentation with Token-Conditioned Neural Cellular Automata](https://arxiv.org/abs/2607.24529)
...
### [38] [Homeostatic Noise Buffering in Biomolecular Condensates Hinges on Phase Multiplicity Modulated by Interfacial and Droplet Size Effects](https://arxiv.org/abs/2607.23382)
