...
### [2] [The Hidden Second Law of Thermodynamics behind the Boltzmann-Grad Limit](https://arxiv.org/abs/2608.25056)
*Zhaohua Wu*
...
### [3] [Wing-Rotor Aerodynamic Interactions in Small UAVs During Hover and Cruise](https://arxiv.org/abs/2608.25150)
...
### [4] [First-principles perturbative theory of anomalous scaling in a stochastic shell model of turbulence](https://arxiv.org/abs/2608.25167)
*Alexei A. Mailybaev*
...
### [5] [Physics-Guided Generative Surrogates for Parametric Rarefied Flows with Neural-Field Auto-Decoders: A Pipeline-Level Study of Flow Matching and Diffusion](https://arxiv.org/abs/2608.25454)
...
### [6] [An SPH--mesh Coupling for Vesicle Dynamics in Shear Flow](https://arxiv.org/abs/2608.25522)
...
### [7] [Vortex filament dynamics and vortex ring motion revisited](https://arxiv.org/abs/2608.25827)
*Andrew D Gilbert*
...
### [8] [Fock-Space Representation of the Lebowitz--Frisch--Helfand Kinetic Model](https://arxiv.org/abs/2608.25833)
*Ilya Karlin*
...
### [9] [A Compensated Koopman Neural Operator with Selective State-Space Dynamics for Unsteady Flows](https://arxiv.org/abs/2608.25879)
...
### [10] [A Scalable OpenLB LAMMPS Framework for Fully Resolved Simulations of Hindered Settling of Arbitrary Non-Spherical Particles](https://arxiv.org/abs/2608.26030)
...
### [11] [Neural-Network and Reduced-order Modeling Workflows for AI-Driven CFD: Fast Response Surfaces, Reduced Dynamics and Jet in Cross-flow Examples](https://arxiv.org/abs/2608.26064)
...
### [12] [Clustering of anterior corneal surface shapes in normal adults](https://arxiv.org/abs/2608.25130)
...
### [13] [Evaluation of the Exradin A30 Parallel Plate Ion Chamber as a Reference Dosimeter in Ultra-High Dose Rate (UHDR) Electron Beams](https://arxiv.org/abs/2608.25131)
...
### [14] [On the Role of Dispersion in One Model of Propagation of Elastic Excitations in Nerves](https://arxiv.org/abs/2608.25408)
*Alexander I. Kozlov*
...
### [15] [Where Energy Is Spent Sets the Depth of Kinetic Proofreading](https://arxiv.org/abs/2608.25748)
*Uğur Çetiner*
...
### [16] [Modality Contribution Score - A Per-Patient Framework for Quantifying the Relative Diagnostic Contribution of Structural MRI and Amyloid PET in Alzheimer's Disease](https://arxiv.org/abs/2608.24931)
...
### [17] [Improving Cross-Site Whole-Heart Segmentation](https://arxiv.org/abs/2608.25109)
...
### [18] [Learning spatially varying regularisation parameters of low regularity for image reconstruction](https://arxiv.org/abs/2608.25127)
