...
### [2] [An exposition on some viscosity dependent issues in refined potential flow theory](https://arxiv.org/abs/2609.10649)
...
### [4] [Mixing dynamics and transport mechanisms during laminar stirring flows](https://arxiv.org/abs/2609.10773)
...
### [5] [Long interfacial internal waves with currents: current profiles with quadratic depth-dependence](https://arxiv.org/abs/2609.10820)
...
### [6] [Giesekus Stick-Slip Singularity: Asymptotic Theory in the Log-Conformation Formulation](https://arxiv.org/abs/2609.10836)
...
### [7] [Correlative effects of induced magnetic field-buoyancy on reactive solute dispersion dynamics in couple-stress fluids](https://arxiv.org/abs/2609.11099)
...
### [8] [A Novel Multi-fidelity Surrogate for Turbomachinery Design Optimization](https://arxiv.org/abs/2609.11111)
...
### [9] [A Novel Multi-fidelity Surrogate for Efficient Turbine Design Optimization](https://arxiv.org/abs/2609.11112)
*Qineng Wang,Liming Song,Zhendong Guo,Jun Li,Zhenping Feng*
...
### [10] [DiffSWE2d: a differentiable Shallow Water Equations solver for end-to-end flood and tsunami modelling](https://arxiv.org/abs/2609.11426)
*Zhonghou Xu*
...
### [11] [Low inertia limit of elasto-inertial turbulence](https://arxiv.org/abs/2609.11581)
...
### [12] [Surface gravity wave-mean flow interaction with comparable spatial scales. Part I: reduced wave equations](https://arxiv.org/abs/2609.11587)
...
### [13] [Surface gravity wave-mean flow interaction with comparable spatial scales. Part II: two-way coupling and wave-wave interactions](https://arxiv.org/abs/2609.11631)
*Basile Gallet*
...
### [14] [A Conservative Hybrid Eulerian-Lagrangian Method with Persistent Structure Tracking for Multiscale Cavitation](https://arxiv.org/abs/2609.11776)
...
### [17] [Physics-Informed Sequential Reconstruction of Scanning Probe Microscopy Images with Calibrated Uncertainty](https://arxiv.org/abs/2609.10638)
...
### [18] [XPos3R: Cross-Modal Transformer for Intraoperative 2D/3D Registration](https://arxiv.org/abs/2609.10733)
...
### [19] [Scale-Aware 3D Deep Learning for Robust Brain Metastasis Detection in Multimodal MRI](https://arxiv.org/abs/2609.10825)
...
### [20] [Annotating anatomy and pathology in the National Lung Screening Trial computed tomography images](https://arxiv.org/abs/2609.10858)
...
### [21] [Seamless Whole Slide Label-Free Virtual Staining](https://arxiv.org/abs/2609.10914)
...
### [22] [Exponential Pixelating Integral transform with dual fractal features for enhanced chest X-ray abnormality detection](https://arxiv.org/abs/2609.10988)
