...
### [1] [Noise-robust navigation from an adaptive run-and-tumble policy](https://arxiv.org/abs/2608.27751)
...
### [2] [RNA-like Polyelectrolyte in a Viral Capsid: Molecular Dynamics with Explicit Electrostatic Interactions](https://arxiv.org/abs/2608.27825)
...
### [3] [High-Order CFD Modeling of Rotating Actuator Line Systems](https://arxiv.org/abs/2608.27943)
...
### [4] [Validation of quasi-two-dimensional model of convection in a transverse magnetic field](https://arxiv.org/abs/2608.28023)
*Alexander Gelfgat*
...
### [5] [How Surface Viscoelasticity Eliminates Satellite Drops](https://arxiv.org/abs/2608.28071)
...
### [6] [A high-order polynomial-corrected shifted boundary method for simulating fully nonlinear water waves](https://arxiv.org/abs/2608.28123)
...
### [7] [Inclination-Induced Crossover in the Velocity Scaling of Lubrication-Mediated Droplet Motion](https://arxiv.org/abs/2608.28203)
...
### [8] [Unsteady airfoil aerodynamics in attached flow: From unsteady thin airfoil theory to wind turbine application](https://arxiv.org/abs/2608.28280)
...
### [9] [LES of iron-powder combustion in a jet-in-hot-coflow burner - Insights on flame structure and ignition characteristics](https://arxiv.org/abs/2608.28294)
...
### [10] [A physics-constrained machine-learning sub-grid-scale modeling approach for turbulent premixed flames](https://arxiv.org/abs/2608.28525)
...
### [11] [Compaction in a deformable porous cylinder with elastic boundaries](https://arxiv.org/abs/2608.28537)
...
### [12] [Destroy Me: Automatic Artifact Generation for Histopathology Images](https://arxiv.org/abs/2608.27516)
...
### [13] [CARDINAL Predicts Cardiovascular Risk From Non-contrast Cardiac CT](https://arxiv.org/abs/2608.27690)
...
### [14] [Do Medical Vision Models Reason About Anatomy? Probing the Spatial Inductive Biases of Learned Visual Representations](https://arxiv.org/abs/2608.28092)
...
### [15] [CheXtriev: Anatomy-Centered Representation for Case-Based Retrieval of Chest Radiographs](https://arxiv.org/abs/2608.28137)
...
### [16] [Physics-Assisted Deep Learning Denoising for Stabilized IMPULSED dMRI Microenvironment Parameter Fitting](https://arxiv.org/abs/2608.27681)
...
### [17] [Dark energy: the cost of function in protein evolution](https://arxiv.org/abs/2608.27711)
