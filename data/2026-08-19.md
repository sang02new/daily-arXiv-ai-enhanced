...
### [2] [ORViT-DR: Ordinally-Robust Hybrid ViT for Low-Resolution Diabetic Retinopathy Grading](https://arxiv.org/abs/2608.16958)
...
### [3] [MagViT: Interpretable Multi-Magnification Transformers with Patient-Level Model Selection for Breast Histopathology](https://arxiv.org/abs/2608.16959)
...
### [5] [Technically Plausible but Clinically Misleading? Expert Evaluation of Patient-Personalized Synthetic Prostate MRI](https://arxiv.org/abs/2608.16964)
...
### [6] [Harnessing Magnitude-Only and Complex Measurements for Improved Dynamic MRI Reconstruction with Learned Priors](https://arxiv.org/abs/2608.18036)
...
### [7] [Primitive Representation Learning for Unsupervised Dynamic Contrast Enhanced MRI Reconstruction](https://arxiv.org/abs/2608.18055)
...
### [8] [Turbulent Microscale Flow Field Prediction In Porous Media Using Convolutional Neural Networks](https://arxiv.org/abs/2608.17062)
...
### [9] [Autonomous route to the strange attractor: the many life stages of the chaotic bubblewheel](https://arxiv.org/abs/2608.17169)
...
### [10] [Noise-separated evidence for a slow collective displacement in a rarefied hypersonic bow-shock layer](https://arxiv.org/abs/2608.17285)
...
### [11] [Optimal control of a swimming robot based on Purcell's microswimmer model](https://arxiv.org/abs/2608.17455)
...
### [12] [Steady transport of active particles under continuous release in confined shear flow](https://arxiv.org/abs/2608.17494)
...
### [13] [Roughness-controlled layer in oscillatory turbulent boundary layers over densely packed uniform roughness](https://arxiv.org/abs/2608.17543)
...
### [14] [Modelling flow-driven pore closure of weakening poroelastic media](https://arxiv.org/abs/2608.17581)
...
### [15] [Towards Rapid Prototyping of Spray Injectors: A Regime-Agnostic Neural Operator Surrogate for Gas-Liquid Interface Evolution](https://arxiv.org/abs/2608.17825)
...
### [16] [A Residual Learning Approach for Unsteady Aerodynamic Load Prediction](https://arxiv.org/abs/2608.17894)
...
### [17] [MolDStruct: benchmarking a hybrid Monte Carlo/Molecular Dynamics model for X-ray free-electron laser ionisation and fragmentation dynamics](https://arxiv.org/abs/2608.17460)
*Friederike Krüger,Simon Liljeblad,Sebastian Cardoch,Måns Rosenbaum,Lasse Eisenach,Ibrahim Dawod,Nicuşor Tîmneanu,Carl Calemanm,Tomas André*
...
### [19] [A higher-derivative model predicts a smoothness vs duration relationship in head-pointing movements](https://arxiv.org/abs/2608.17904)
...
### [20] [LV-CARE-Diff: A Conditional Anatomy-Aware Diffusion Model for Left Ventricular Shape Reconstruction and Function Quantification from Ultra-Sparse Cine Slices](https://arxiv.org/abs/2608.17357)
...
### [21] [Flexible Piezoresistive Yarn Pressure Sensor for Arterial Blood Pressure Waveform Measurement](https://arxiv.org/abs/2608.17974)
