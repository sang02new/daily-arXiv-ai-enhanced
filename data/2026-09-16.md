...
### [1] [Limits of Inferring Parametric Response from Single-Condition Trajectories inStochastic Reaction Networks](https://arxiv.org/abs/2609.17031)
*Quentin Thommen*
...
### [2] [Geant4 Simulation of an X-ray Beam Monitoring Detector based on plastic scintillators](https://arxiv.org/abs/2609.16397)
...
### [3] [Closing the gap: A two-site MLC matching study for Varian TrueBeam Linear Accelerators](https://arxiv.org/abs/2609.16473)
...
### [4] [A deep dive into Tollmien-Schlichting wave control via passive wall deformations: The battle between local and downstream stabilization, lessons learned, and implications for phononic subsurfaces](https://arxiv.org/abs/2609.16144)
...
### [5] [Computer-assisted global regularity across nonlinear families of three-dimensional periodic Navier-Stokes flows](https://arxiv.org/abs/2609.16157)
...
### [7] [Improving Reduced-Order Rotating Detonation Engine Models with Data Assimilation and Machine Learning](https://arxiv.org/abs/2609.16237)
...
### [8] [Stratified jet with wall effects](https://arxiv.org/abs/2609.16418)
...
### [9] [Extensible membranes in inviscid flow: aerodynamics and singular limits](https://arxiv.org/abs/2609.16484)
...
### [10] [Inertialess turbulence in viscoelastic pipe flow](https://arxiv.org/abs/2609.16492)
...
### [11] [Does the Boussinesq approximation correctly describe statistically stationary states of Rayleigh-Bénard convection?](https://arxiv.org/abs/2609.16634)
*Erik Lindborg*
...
### [12] [Turbulence at an aerofoil leading edge: the linearity boundary and its generation mechanism](https://arxiv.org/abs/2609.16709)
...
### [13] [Rotation Collision based Quantum Lattice Boltzmann Methods](https://arxiv.org/abs/2609.16721)
...
### [14] [Direct Trajectory Reconstruction for Fast 3D X-ray Particle Tracking Velocimetry in Porous Media](https://arxiv.org/abs/2609.16838)
...
### [15] [A derivative-free framework for capturing macroscopic behavior of incompressible turbulent flows](https://arxiv.org/abs/2609.17323)
...
### [16] [Exploring Optimal Parameters for Ligand-Based Virtual Screening in Early Drug Discovery](https://arxiv.org/abs/2609.16356)
...
### [17] [SaltyMeta: a curated benchmark and protein language model-informed web tool for salty peptide prediction](https://arxiv.org/abs/2609.16809)
...
### [18] [A deep dictionary network-based foundation model for ultra-low-dose CT denoising](https://arxiv.org/abs/2609.16031)
...
### [19] [Conditioning noise is a free regularizer for LoRA fine-tuning: no pathology encoder required for diffusion-based artifact detection in histopathology](https://arxiv.org/abs/2609.16032)
...
### [20] [LM-PCVMNet: Pediatric Cervical Vertebral Maturation Analysis with Deep Fusion of Landmarks and Metadata](https://arxiv.org/abs/2609.16033)
...
### [21] [Automated Distinction of Intimal and Medial Intracranial Arterial Calcification from CT Head](https://arxiv.org/abs/2609.16035)
...
### [22] [Anatomy-Change-Aware Bidirectional Selective State-Space Memory for Clinically Deployed Thoracic Radiotherapy Auto-Contouring](https://arxiv.org/abs/2609.16036)
...
### [23] [Multisource Remote Sensing and Geospatial Analysis of Vineyard Wildfire Impacts and Resilience: The 2019 Kincade Fire](https://arxiv.org/abs/2609.16168)
...
### [24] [A Sentinel-2 benchmark dataset for deep-learning active-fire segmentation across 25 California wildfires](https://arxiv.org/abs/2609.16199)
...
### [25] [Semantic-Aware Neural Video Codec for Error-Resilient Low-Latency Transmission](https://arxiv.org/abs/2609.16279)
...
### [26] [StainBridge: Stain-Aware Pairwise Registration of Serial Renal Biopsy Whole-Slide Images Across Structural and Immunohistochemical Stains](https://arxiv.org/abs/2609.17090)
...
### [27] [Quantum-Inspired Trainable and Parameter-Efficient Tensor Networks for Image Inpainting](https://arxiv.org/abs/2609.17298)
