...
### [1] [Toward Multi-Modal Deep Learning for Pulmonary Disease Classification: A Texture-Based Machine Learning Pilot Study on Public Chest X-Ray Data](https://arxiv.org/abs/2607.27286)
...
### [2] [Endo-NeRF++: Uncertainty-Aware Neural Rendering with Multi-Resolution Hash Encoding for Dynamic Surgical Scene Reconstruction](https://arxiv.org/abs/2607.27825)
...
### [3] [TSOG: A Format For Temporally And Spatially Ordered Gaussians](https://arxiv.org/abs/2607.28049)
...
### [4] [ReGenVC: End-to-End Real-Time Generative Video Coding at Ultra-Low Bitrate](https://arxiv.org/abs/2607.28144)
...
### [5] [Rethinking Artificial Intelligence in Medical Imaging: Assumptions, Reality, and Reframing](https://arxiv.org/abs/2607.27428)
...
### [6] [Three-Photon Bayesian Imaging of Ortho-Positronium](https://arxiv.org/abs/2607.27741)
...
### [7] [A reduced viscoelastic FDTD formulation for ultrasound-driven shear wave propagation in soft tissue](https://arxiv.org/abs/2607.28414)
*Gianmarco Pinton*
...
### [8] [Continuous Game of Life: cell emergence and self-organization at the edge of growth](https://arxiv.org/abs/2607.27402)
...
### [9] [Do ions have a coating in neuronal electrolytes under an electric field?](https://arxiv.org/abs/2607.27446)
*János Végh*
...
### [10] [Information-driven stepping in dimeric transport motors](https://arxiv.org/abs/2607.27495)
...
### [11] [A sub-grid-scale model for polydisperse bubbly flows with heat and mass transfer](https://arxiv.org/abs/2607.27426)
...
### [12] [Kinetic Linear Stability Theory for High-Speed Compressible Flows: A High Performance Computing Framework](https://arxiv.org/abs/2607.27440)
...
### [13] [Role of gravity on preferential clustering of microparticles in unsteady wake flows](https://arxiv.org/abs/2607.27459)
...
### [14] [Gaussian non relativistic spontaneously stochastic hydrodynamics](https://arxiv.org/abs/2607.27540)
...
### [15] [Modified Dynamic Mixed Subgrid-scale Models for Geophysical Flows: Forced Two-Dimensional and $β$-plane Turbulence](https://arxiv.org/abs/2607.27567)
...
### [16] [Mesh Adaptation on Hybrid Unstructured Meshes for Immersed Boundary Methods](https://arxiv.org/abs/2607.27580)
...
### [17] [Compressible solved-volatility stochastic fluid thermodynamics: source-consistent energy, finite-correlation reservoirs, entropy admissibility and boundary conditions](https://arxiv.org/abs/2607.28333)
*Hsieh-Chen Tsai*
